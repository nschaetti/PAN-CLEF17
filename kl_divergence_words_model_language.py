...
if __name__ == "__main__":
    ...
    # Argument parser
    parser = argparse.ArgumentParser(description="PAN17 KL divergence for language variety classification")
    ...
    with open(args.file, 'r') as f:
        ...
        # Probabilistic model
        language_model = PAN17KLDivergenceModel(classes=data_set['languages'], upper=False)
        ...
        # end for
        print("10K Fold error rate for is %f" % np.average(error_rate_average))
    # end with

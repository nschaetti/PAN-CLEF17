...
if __name__ == "__main__":
    ...
    with open(args.file, 'r') as f:
        ...
        reducer = PAN17LetterGramsReducer(
            letters=PORTUGUESE_ALPHABET,
            punctuations=PORTUGUESE_PUNCTUATIONS, add_punctuation=True, add_first_letters=True, add_end_letters=True,
            add_end_grams=True, add_first_grams=True, upper_case=args.upper)

        # Matrix generator
        matrix_generator = PAN17FeaturesMatrixGenerator(letters=PORTUGUESE_ALPHABET,
                                              punctuations=PORTUGUESE_PUNCTUATIONS, upper_case=args.upper)

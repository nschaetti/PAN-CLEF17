...
# Spanish Alphabet
#
SPANISH_ALPHABET = u"AaÀàÁáÂâÃãBbCcÇçDdEeÉéÈèÊêFfGgHhIiÍíÏïÎîJjKkLlMmNnÑñOoÓóÔôÕõPpQqRrSsTtUuÚúÜüÛûVvWwXxYyZz?¿.!¡,;:"
SPANISH_PUNCTUATIONS = u"?¿.!¡,;:"


# An Author
class PAN17SpanishTextCleaner(PySpeechesCleaner):
    ...
    def __init__(self):
        ...
        Constructor.
        """
        super(PAN17SpanishTextCleaner, self).__init__()
    # end __init__
    ...
    def keep_only_letters(text):
        ...
        cleaned_text = ""
        for letter in text:
            if letter in SPANISH_ALPHABET or letter == " ":
                cleaned_text += letter
        # end for
        return cleaned_text
    # Clean text
    ...
    def clean_text(text):
        ...
        text = PAN17SpanishTextCleaner.remove_twitter_quotes(text)  # Remove Twitter quotes.
        ...
        text = PAN17SpanishTextCleaner.keep_only_letters(text)  # Keep only Portuguese letters.
